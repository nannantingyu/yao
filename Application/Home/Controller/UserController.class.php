...
class UserController extends HomeController {
	...
	public function myorder(){
		...
		$allOrders = M('order_info')
			...
			->field('zc_goods.goods_name, zc_goods.goods_id, zc_order_info.order_id, zc_order_goods.goods_number, zc_goods.goods_img, zc_goods.promote_price, zc_order_goods.order_status, zc_order_info.add_time')
			->select();
