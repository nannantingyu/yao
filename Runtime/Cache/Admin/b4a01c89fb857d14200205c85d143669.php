...
<script>
	...
	<div class="main-title cf">
		<h2><?php if(isset($banner)): ?>编辑<?php else: ?>新增<?php endif; ?>广告</h2>
	</div>
	...
	<form method="post" class="form-horizontal">
		<div class="form-item cf">
			...
			<div class="controls">
				<input type="text" value="<?php echo ($banner["title"]); ?>" name="title" class="text input-large">
			</div>
		</div>
		...
		<div class="form-item cf">
			...
			<div class="controls">
				<input type="text" value="<?php echo ($banner["link"]); ?>" name="link" class="text input-large">
			</div>
		</div>
		...
		<div class="form-item cf">
			...
			<div class="controls">
				...
				<div class="upload-img-box">
					<?php if(isset($banner['image'])): ?><div class="upload-pre-item"><img id="banner_img" src="<?php echo ($banner['image']); ?>"/></div><?php endif; ?>
				</div>
			</div>
			<script type="text/javascript">
				...
				$("#upload_file_banner_img").uploadify({
					...
					"buttonText"      : "上传图片",
					"uploader"        : "<?php echo U('File/uploadBanner',array('session_id'=>session_id()));?>",
					"width"           : 120,
					'removeTimeout'	  : 1,
		...
		<div class="form-item cf">
			...
			<div class="controls">
				<input type="text" value="<?php echo ((isset($banner["created_time"]) && ($banner["created_time"] !== ""))?($banner["created_time"]):date('Y-m-d H:i:s')); ?>" name="created_time" class="text input-large">
			</div>
		</div>
		...
		<div class="form-item cf">
			...
			<div class="controls">
				<select name="state">
					<option value="1" <?php if(($banner["state"]) == "1"): ?>selected<?php endif; ?>>发布</option>
					<option value="0" <?php if(($banner["state"]) == "0"): ?>selected<?php endif; ?>>下线</option>
				</select>
			</div>
		</div>
