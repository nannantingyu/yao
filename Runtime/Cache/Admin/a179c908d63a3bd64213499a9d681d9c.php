...
<script>
    ...
    <div class="cf">
        <div class="fl">
            <select id="cat_id">
                ...
                <?php if(is_array($cats)): $i = 0; $__LIST__ = $cats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["cat_id"]); ?>" <?php if($cat_id == $vo['cat_id']): ?>selected<?php endif; ?>><?php echo ($vo["cat_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>

            <a class="btn" href="<?php echo U("goods/editattr");?>">添 加</a>
        </div>
    </div>
    ...
    <div class="data-table">
        <table class="">
            ...
            <tbody>
            <?php if(is_array($allGattrs)): $i = 0; $__LIST__ = $allGattrs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><span><?php echo ($vo["attr_values"]); ?></span></td>
                    <td><span><?php echo ($vo["sort_order"]); ?></span></td>
                    <td><span><?php echo ($vo["is_linked"]); ?></span></td>
                    <td><span><?php echo ($vo["attr_group"]); ?></span></td>
                    <?php $p = I('get.p', 1); $cat = I('get.cat_id'); $cats = ''; if($cat){ $cats = '&cat_id='.$cat; } ?>
                    <td><a href="<?php echo U('goods/editattr?attr_id='.$vo['attr_id'].'&p='.$p.$cats);?>">编辑</a>
                        <a href="javascript:void(0);" onclick="delAttr(this, <?php echo ($vo["attr_id"]); ?>)">删除</a>
                    </td>
