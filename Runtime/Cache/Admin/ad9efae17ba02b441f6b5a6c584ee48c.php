...
<body>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo U('menus/editmenus');?>">新 增</a>
        </div>
    ...
    <tbody>
		<?php if(!empty($allMenuss)): if(is_array($allMenuss)): $i = 0; $__LIST__ = $allMenuss;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><?php echo ($vo["menu_type"]); ?></td>
			<td><?php echo ($vo["menu_value"]); ?></td>
			<td>
				<a href="<?php echo U('Menus/editmenus?id='.$vo['id']);?>">编辑</a>
