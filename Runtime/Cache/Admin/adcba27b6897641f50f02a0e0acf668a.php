...
<script>
    ...
    <div class="cf">
        <div class="fl">
            <a class="btn" href="<?php echo U("goods/editcat");?>">添 加</a>
        </div>
    </div>
    ...
    <div class="data-table">
        <table class="">
            ...
            <tbody>
            <?php if(is_array($allCategory)): $i = 0; $__LIST__ = $allCategory;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    <td><input class="ids" type="checkbox" name="ids[]" value="<?php echo ($vo["id"]); ?>" /></td>
                    <td><?php echo ($vo["cat_id"]); ?> </td>
                    <td><?php echo ($vo["cat_name"]); ?></td>
                    <td><span><?php echo ($vo["measure_unit"]); ?></span></td>
                    <td><span><?php echo ($vo["is_show"]); ?></span></td>
                    <td><span><?php echo ($vo["parent_id"]); ?></span></td>
                    <td><span><?php echo ($vo["sort_order"]); ?></span></td>
                    <td><a href="<?php echo U('goods/editcat?cat_id='.$vo['cat_id']);?>">编辑</a>
                        <a href="javascript:void(0);" onclick="delType(this, <?php echo ($vo["cat_id"]); ?>)" class="ajax-get">删除</a>
                    </td>
