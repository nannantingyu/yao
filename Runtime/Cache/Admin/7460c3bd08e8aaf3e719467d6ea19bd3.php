...
<script>
    ...
    <div class="cf">
        <div class="fl">
            <a class="btn" href="<?php echo U("goods/editgoods");?>">添 加</a>
        </div>
    </div>
    ...
    <div class="data-table">
        <table class="">
            ...
            <tbody>
            <?php if(is_array($allGoods)): $i = 0; $__LIST__ = $allGoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    <td><input class="ids" type="checkbox" name="ids[]" value="<?php echo ($vo["id"]); ?>" /></td>
                    <td><?php echo ($vo["goods_id"]); ?> </td>
                    <td><?php echo ($vo["cat"]); ?></td>
                    <td><?php echo ($vo["goods_name"]); ?></td>
                    <td><img width="50" height="50" src="<?php echo getImgsrc($vo['goods_img']);?>"/></td>
                    <td><?php echo ($vo["brand"]); ?></td>
                    <td><?php echo ($vo["shop_price"]); ?></td>
                    <td><?php if(($vo["is_promote"]) == "1"): ?><a href="javascript:void(0);" onclick="setOnSale(this, <?php echo ($vo["goods_id"]); ?>, 0, 'is_promote', '是', '否')">是</a><?php else: ?><a href="javascript:void(0);" onclick="setOnSale(this, <?php echo ($vo["goods_id"]); ?>, 1, 'is_promote', '是', '否')">否</a><?php endif; ?></td>
                    <td><?php if(($vo["is_on_sale"]) == "1"): ?><a href="javascript:void(0);" onclick="setOnSale(this, <?php echo ($vo["goods_id"]); ?>, 0, 'is_on_sale', '在售', '下架')">在售</a><?php else: ?><a href="javascript:void(0);" onclick="setOnSale(this, <?php echo ($vo["goods_id"]); ?>, 1, 'is_on_sale', '在售', '下架')">下架</a><?php endif; ?></td>
                    <td><?php echo (date('Y-m-d H:i:s', strtotime($vo["add_time"]))); ?></td>
                    <?php $p = I('get.p', 1); ?>
                    <td><a href="<?php echo U('Goods/editgoods?id='.$vo['goods_id'].'&p='.$p);?>">编辑</a>
                        <a href="javascript:void(0);" onclick="delGoods(this, <?php echo ($vo["goods_id"]); ?>)">删除</a>
                    </td>
