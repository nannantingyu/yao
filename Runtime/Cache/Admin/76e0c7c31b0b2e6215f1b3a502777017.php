...
<script>
	...
	<div class="main-title cf">
		<h2><?php if(isset($types)): ?>编辑<?php else: ?>新增<?php endif; ?>分类</h2>
	</div>
	...
	<form method="post" class="form-horizontal">
		<div class="form-item cf">
			...
			<div class="controls">
				<input type="text" value="<?php echo ($cat["cat_name"]); ?>" name="cat_name" class="text input-large">
			</div>
		</div>
		...
		<div class="form-item cf">
			...
			<div class="controls">
				<select name="parent_id" class="input-large">
					...
					<?php if(is_array($topcats)): $i = 0; $__LIST__ = $topcats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["cat_id"]); ?>" <?php if($cat['parent_id'] == $vo['cat_id']): ?>selected<?php endif; ?>><?php echo ($vo["cat_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
			</div>
		</div>
		...
		<div class="form-item cf">
			...
			<div class="controls">
				<input type="radio" <?php if($cat['is_show'] == 1): ?>checked<?php endif; ?> name="enabled" class="text input-small">启用
				<input type="radio" <?php if($cat['is_show'] == 0): ?>checked<?php endif; ?> name="enabled" class="text input-small">禁用
			</div>
		</div>
		...
		<div class="form-item cf">
			...
			<div class="controls">
				<input type="text" value="<?php echo ($cat["sort_order"]); ?>" name="sort_order" class="text input-large">
			</div>
		</div>
		...
		<div class="form-item cf">
			...
			<div class="controls">
				<input type="text" value="<?php echo ($cat["measure_unit"]); ?>" name="measure_unit" class="text input-large">
			</div>
		</div>
	...
	<script type="text/javascript">
		$(function(){
			//导航高亮
			highlight_subnav('<?php echo U('goods/type');?>');
		})
	</script>
