...
<script>
    ...
    <div class="cf">
        <div class="fl">
            <input type="text" id="search" placeholder="请输入产品名称" value="<?php echo I('get.key');?>" class="text input-mid">
    ...
    <div class="data-table">
        <table class="">
            ...
            <?php if(is_array($allGattrs)): $i = 0; $__LIST__ = $allGattrs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($vo["goods_attr_id"]); ?> </td>
                    <td><?php echo ($vo["goods_name"]); ?></td>
                    <td><?php echo ($vo["attr_name"]); ?></td>
                    <td><?php echo ($vo["attr_value"]); ?></td>
                    <td><span><?php echo ($vo["attr_price"]); ?></span></td>
                    <?php $p = I('get.p', 1); ?>
                    <td><a href="<?php echo U('goods/editgattr?goods_attr_id='.$vo['goods_attr_id'].'&p='.$p);?>">编辑</a>
                        <a href="javascript:void(0);" onclick="delAttr(this, <?php echo ($vo["goods_attr_id"]); ?>)">删除</a>
                    </td>
