...
<script>
	...
	<div class="main-title cf">
		<h2><?php if(isset($types)): ?>编辑<?php else: ?>新增<?php endif; ?>商品属性</h2>
	</div>
	...
	<form method="post" class="form-horizontal">
		<div class="form-item cf">
			...
			<div class="controls">
				<input type="text" value="<?php echo ($goods["goods_name"]); ?>" disabled class="text input-large">
		...
		<div class="form-item cf">
			...
			<div class="controls">
				<select name="attr_id">
					<?php if(is_array($allAttr)): $i = 0; $__LIST__ = $allAttr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($goods_attr['attr_id'] == $vo['attr_id']): ?>selected<?php endif; ?> value="<?php echo ($vo["attr_id"]); ?>"><?php echo ($vo["attr_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
			</div>
		</div>
		...
		<div class="form-item cf">
			...
			<div class="controls">
				<input type="text" value="<?php echo ($goods_attr["attr_value"]); ?>" name="attr_value" class="text input-large">
			</div>
		</div>

		<div class="form-item cf">
			<label class="item-label">属性价格</label>
			<div class="controls">
				<input type="text" value="<?php echo ($goods_attr["attr_price"]); ?>" name="attr_price" class="text input-large">
			</div>
		</div>

		<input type="hidden" name="goods_attr_id" value="<?php echo ($goods_attr["goods_attr_id"]); ?>">
