...
<script>
	...
	<div class="main-title cf">
		<h2><?php if(isset($goods)): ?>编辑<?php else: ?>新增<?php endif; ?>品牌</h2>
	</div>
	...
	<form method="post" class="form-horizontal">
		<div class="form-item cf">
			...
			<div class="controls">
				<input type="text" value="<?php echo ($brand["brand_name"]); ?>" name="brand_name" class="text input-large">
			</div>
		</div>
		...
		<div class="form-item cf">
			...
			<div class="controls">
				<input type="text" value="<?php echo ($brand["brand_desc"]); ?>" name="brand_desc" class="text input-large">
			</div>
		</div>
		...
		<div class="form-item cf">
			...
			<div class="controls">
				...
				<input type="hidden" name="brand_logo" value="<?php echo ($brand['brand_logo']); ?>"/>
				<div class="upload-img-box">
					<?php if(isset($brand["brand_logo"])): ?><div class="upload-pre-item"><img id="brand_logo" src="<?php echo ($brand['brand_logo']); ?>"/></div><?php endif; ?>
				</div>
			</div>
			<script type="text/javascript">
				...
				$("#upload_file_brand_logo").uploadify({
					...
					"buttonText"      : "上传图片",
					"uploader"        : "<?php echo U('File/uploadBrand',array('session_id'=>session_id()));?>",
					"width"           : 120,
					'removeTimeout'	  : 1,
	...
	<script type="text/javascript">
		$(function(){
			//导航高亮
			highlight_subnav('<?php echo U('goods/brand');?>');
		})
	</script>
