...
<body>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo U('order/editorders');?>">新 增</a>
        </div>
    ...
    <tbody>
		<?php if(!empty($allOrders)): if(is_array($allOrders)): $i = 0; $__LIST__ = $allOrders;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td>
						<a href="<?php echo U('Order/editorders?id='.$vo['id']);?>">详细</a>
					</td>
