   ...
   <div class="panel-body">
        <ul class="list-group">
            ...
            <table class="table table-striped mytb">
                ...
                <tr><td colspan="4"></td><td>商品总计：<?php echo ($gsprice); ?>元<br><br><a href="javascript:void(0)" onclick="checkAll()" class="btn btn-danger">付款</a></td></tr>
            </table>
            </li>
        </ul>
    </div>
        <input type="hidden" id="order_id" value="<?php echo I('get.order');?>">
   </div>
</div>
</div>
