...
<script type="text/javascript" src="http://api.map.baidu.com/api?v=20&ak=OqmGE2XTkFv17CNgehH5lfOxDLPh8Lj5"></script>
	<!--//////////////////////////////////////////////////-->
	<!--///////////////////Contact Page///////////////////-->
	<!--//////////////////////////////////////////////////-->
			...
			<div class="row">
				...
				<div class="col-md-6" style="margin-bottom: 30px;">
					<form name="form1" id="ff" method="post" action="contact.php">
						...
						<div class="form-group">
							<input type="tel" class="form-control" placeholder="您的电话 *" name="phone" id="phone" required data-validation-required-message="Please enter your phone number.">
						</div>
						<div class="form-group">
							<textarea class="form-control" placeholder="您的消息 *" name="message" id="message" required data-validation-required-message="Please enter a message."></textarea>
						</div>
						<button type="submit" class="btn btn-1">发送</button>
					</form>
				</div>
				<div class="col-md-6">
					<p><span class="glyphicon glyphicon-home"></span> 哈尔滨市东北农业大学</p>
					<p><span class="glyphicon glyphicon-earphone"></span> +6221 888 888 90 , +6221 888 88891</p>
					<p><span class="glyphicon glyphicon-envelope"></span> yaog@521.com</p>
	...
	<script type="text/javascript">
		...
		map.centerAndZoom(new BMap.Point(126.719, 45.740), 13);  // 初始化地图,设置中心点坐标和地图级别
